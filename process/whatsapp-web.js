...
var data = [
    ...
    { id: 3, received: 'Can we have a call?', reply: 'Please leave a voicemail. Let us connect in an hour. Kind Regards'},
    { default: 'Please leave a voicemail. Let us connect in an hour. Kind Regards' }
];
client.on('message', message => {
